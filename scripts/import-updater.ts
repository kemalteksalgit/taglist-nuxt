...
const importMappings = {
  ...
  // Services moved from experimental
  '@/services/experimental/VisualSearchService': '@/services/VisualSearchService',
  '~/services/experimental/VisualSearchService': '~/services/VisualSearchService',
  '../experimental/VisualSearchService': '../VisualSearchService',
  './experimental/VisualSearchService': './VisualSearchService',
  
  '@/services/experimental/EnhancedLiveStreamingService': '@/services/EnhancedLiveStreamingService',
  '~/services/experimental/EnhancedLiveStreamingService': '~/services/EnhancedLiveStreamingService',
  '../experimental/EnhancedLiveStreamingService': '../EnhancedLiveStreamingService',
  './experimental/EnhancedLiveStreamingService': './EnhancedLiveStreamingService'
}
  ...
  try {
    ...
    for (const [oldPath, newPath] of Object.entries(importMappings)) {
      ...
      const patterns = [
        ...
        new RegExp(`(require\\()['"]${oldPath.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')}\\.vue(['"])`, 'g')
      ]
